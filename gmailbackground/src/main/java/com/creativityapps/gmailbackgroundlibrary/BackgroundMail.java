package com.adirahav.diraleashkaa.gmailbackgroundlibrary;
...
import com.adirahav.diraleashkaa.gmailbackgroundlibrary.R;
import com.adirahav.diraleashkaa.gmailbackgroundlibrary.util.GmailSender;
import com.adirahav.diraleashkaa.gmailbackgroundlibrary.util.Utils;
...
public class BackgroundMail {
    ...
    public static final class Builder {
        ...
        public Builder withMailFrom(@NonNull String mailFrom) {
            this.mailFrom = mailFrom;
            return this;
        }

        public Builder withMailFrom(@StringRes int mailFromRes) {
            this.mailFrom = context.getResources().getString(mailFromRes);
            return this;
        }
