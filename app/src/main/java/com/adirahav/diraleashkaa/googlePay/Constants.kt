...
object Constants {
    ...
    const val PAYMENTS_ENVIRONMENT_TEST = WalletConstants.ENVIRONMENT_TEST  // ADITEST
     ...
     */
    val SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("IL")
