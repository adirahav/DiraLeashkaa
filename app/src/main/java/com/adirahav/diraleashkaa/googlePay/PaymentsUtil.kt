...
package com.adirahav.diraleashkaa.googlePay

import android.app.Activity
import android.app.Application
import com.adirahav.diraleashkaa.BuildConfig
import com.adirahav.diraleashkaa.googlePay.Constants.SUPPORTED_METHODS
import com.adirahav.diraleashkaa.googlePay.Constants.SUPPORTED_NETWORKS
...
object PaymentsUtil {
    ...
    private fun directTokenizationSpecification(): JSONObject {
        ...
        return JSONObject().apply {
            put("type", "DIRECT")
            put("parameters", JSONObject(Constants.DIRECT_TOKENIZATION_PARAMETERS as Map<String?, String?>))
        }
    }
     ...
     */
    fun createPaymentsClient(activity: Application): PaymentsClient {
        val walletOptions = Wallet.WalletOptions.Builder()
            .setEnvironment(
                if (BuildConfig.BUILD_TYPE.equals("debug"))
                    Constants.PAYMENTS_ENVIRONMENT_TEST
                else
