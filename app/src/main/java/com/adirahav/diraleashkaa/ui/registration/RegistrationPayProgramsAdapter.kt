...
class RegistrationPayProgramsAdapter(
        private val context: Context,
        private val listener: OnProgramAdapter,
        private val fragment: RegistrationPayProgramFragment
) : RecyclerView.Adapter<RegistrationPayProgramsAdapter.ViewHolder>() {

    //region == companion ==========

    companion object {
        private const val TAG = "SignUpPayProgramsAdapter"
    }

    //endregion == companion ==========

    // layout
    //private var layout: AdapterPayProgramsBinding? = null

    // resources
    val resources: Resources = AppApplication.context.resources

    // program
    private var programs: List<PayProgramTypeEntity?>?

    interface OnProgramAdapter {
        fun onProgramClicked(property: PayProgramTypeEntity?, selectedPosition: Int)
    }
    ...
    fun setItems(programs: List<PayProgramTypeEntity?>?) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.container!!.setOnClickListener {
            ...
            if (fragment.selectedPosition != null) {
                val _selectedHolder = fragment.layout.programsList.findViewHolderForAdapterPosition(fragment.selectedPosition!!)  as RegistrationPayProgramsAdapter.ViewHolder?
