...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
     ...
     */
    private String mNoDataText = "אין מספיק נתונים להצגה";
    ...
    protected void init() {
        ...
        mInfoPaint.setColor(Color.rgb(130, 132, 135)); // ADITEST #828487
        mInfoPaint.setTextAlign(Align.CENTER);
        //mInfoPaint.setTextSize(Utils.convertDpToPixel(12f));
        mInfoPaint.setTextSize(Utils.convertDpToPixel(16f));    // ADITEST
